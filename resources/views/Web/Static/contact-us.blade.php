...
@section('content')
    ...
    <!-- Start All Title Box -->
    <div class="all-title-box" id="contact_us_image">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Contact Us</h2>
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        <h2>CONTACT INFO</h2>
                        <p> Get in touch with gouda store.  You can send an email for a specific inquiry. </p>
                        <ul>
                            <li>
                ...
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        <h2>GET IN TOUCH</h2>
                        <p> Fill in your details in the form below   <br> WARNING: Now form is not active you can reach us using number in footer :) </p>
                        <form id="contactForm">
                            <fieldset disabled>
                            <div class="row">
                                <div class="col-md-12">
